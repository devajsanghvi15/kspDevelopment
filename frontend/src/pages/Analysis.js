          ...
          {showBoxes && (
            <div className="analysis-container">
              <div className="row">
                ...
                <div className="box box-100"><SeverityLineNew district={prevSelectedDistrict} /></div>
              </div>
              <div className="row">
                {/* <div className="box box-50"><MainCausePie district={prevSelectedDistrict} /></div> */}
                <div className="box box-50"><MainCausePieNew district={prevSelectedDistrict} /></div>

                {/* <div className="box box-50"><AccOverYearsDis district={prevSelectedDistrict} /></div> */}
                <div className="box box-50"><AccOverYearsDisNew district={prevSelectedDistrict} /></div>
              </div>
            </div>
          )}
        </div>
